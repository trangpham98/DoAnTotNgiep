package com.hust.sophia.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.hust.sophia.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.hust.sophia.repository.UserRepository.USERS_BY_EMAIL_CACHE);
